...
export const PATH_DASHBOARD = {
  ...
  user: {
    ...
    edit: (id) => path(ROOTS_DASHBOARD, `/user/edit?id=${id}`),
  ...
  request: {
    ...
    toWithdrawalList: path(ROOTS_DASHBOARD, '/request/to-withdrawal-list'),
  },
  period: {
    root: path(ROOTS_DASHBOARD, '/period'),
    new: path(ROOTS_DASHBOARD, '/period/new'),
    list: path(ROOTS_DASHBOARD, '/period/list'),
    edit: (id) => path(ROOTS_DASHBOARD, `/period/edit?id=${id}`),
    profile: (id) => path(ROOTS_DASHBOARD, `/period/profile?id=${id}`),
  },
  investor: {
    root: path(ROOTS_DASHBOARD, '/investor'),
    new: path(ROOTS_DASHBOARD, '/investor/new'),
    list: path(ROOTS_DASHBOARD, '/investor/list'),
    edit: (id) => path(ROOTS_DASHBOARD, `/investor/edit?id=${id}`),
    account: (id) => path(ROOTS_DASHBOARD, `/investor/account?id=${id}`),
  },
  dividing: {
